...
function Service(options) {
    ...
    this.getAliasVersions = (alias, callback) => {
        if (this.storageProvider.getHashForAlias) {
            return this.storageProvider.getHashForAlias(alias, callback);
        }

        this.storageProvider.getAliasVersions(this.favouriteEndpoint, alias, callback);
    }
    ...
    this.updateAlias = (alias, value, lastValue, callback) => {
        if (this.storageProvider.attachHashToAlias) {
            return this.storageProvider.attachHashToAlias(alias, value, lastValue, callback);
        }
        this.storageProvider.updateAlias(this.favouriteEndpoint, alias, value, lastValue, callback);
    }
