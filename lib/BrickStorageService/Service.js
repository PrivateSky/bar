...
function Service(options) {
    ...
    this.getAliasVersions = (alias, callback) => {
        const method = (this.storageProvider.getHashForAlias) ?
            this.storageProvider.getHashForAlias :
            this.storageProvider.getAliasVersions;

        method.call(this.storageProvider, alias, callback);
    }
    ...
    this.updateAlias = (alias, value, callback) => {
        const method = (this.storageProvider.attachHashToAlias) ?
            this.storageProvider.attachHashToAlias :
            this.storageProvider.updateAlias;

        method.call(this.storageProvider, alias, value, callback);
    }
    ...
    this.getBrick = (hash, callback) => {
        this.storageProvider.getBrick(hash, callback);
    }
    ...
    this.putBrick = (brick, callback) => {
        this.storageProvider.putBrick(brick, callback);
    }
}
