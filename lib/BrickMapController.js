 ...
 * @param {string=} options.bricksDomain
 */
function BrickMapController(options) {
    ...
    const bricksDomain = options.bricksDomain
    ...
    this.getHashLinkBricksDomain = (keySSI) => {
        return bricksDomain || keySSI.getDLDomain();
    }
        ...
        moveNewDiffsToPendingAnchoringState((err) => {
            ...
            strategy.compactDiffs(pendingAnchoringDiffs, (err, brickMap) => {
                ...
                this.saveBrickMap(keySSI, brickMap, (err, hash) => {
                    ...
                    const hashLink = keyssi.buildHashLinkSSI( this.getHashLinkBricksDomain(keySSI), hash, keySSI.getControl(), keySSI.getVn(), keySSI.getHint());
