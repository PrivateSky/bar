    ...
    this.getHashLink = (callback) => {
        ...
        this.getTransformedData((err, _transformedData) => {
            ...
            crypto.hash(options.templateKeySSI, _transformedData, (err, _hash) => {
                ...
                hashLink = keySSISpace.buildTemplateHashLinkSSI(options.templateKeySSI.getDLDomain(), _hash, options.templateKeySSI.getControl(), options.templateKeySSI.getVn(), options.templateKeySSI.getHint());
