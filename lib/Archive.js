...
function Archive(archiveConfigurator) {
    ...
    const initialize = () => {
        ...
        anchoringService = new AnchoringService({
            bar: this
        });
    }
    ...
    this.getBarMapId = () => {
        return archiveConfigurator.getBarMapId();
    };
    ...
    this.getAnchorVerificationStrategy = () => {
        return archiveConfigurator.getAnchorVerificationStrategy();
    }
