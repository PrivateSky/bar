...
function Archive(archiveConfigurator) {
    ...
    const initialize = (callback) => {
        archiveConfigurator.getKeySSI((err, keySSI) => {
            ...
            const bricksDomain = archiveConfigurator.getBricksDomain()
            let storageProvider = archiveConfigurator.getBootstrapingService();
            brickStorageService = buildBrickStorageServiceInstance(keySSI, storageProvider, bricksDomain);
     ...
     */
    function buildBrickStorageServiceInstance(keySSI, storageProvider, bricksDomain) {
