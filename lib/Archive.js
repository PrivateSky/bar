...
function Archive(archiveConfigurator) {
    ...
    const initialize = (callback) => {
        archiveConfigurator.getKeySSI((err, keySSI) => {
            ...
            brickMapController = new BrickMapController({
                ...
                brickStorageService,
                keySSI,
                bricksDomain: archiveConfigurator.getBricksDomain()
            });
    ...
    const _readFile = (barPath, callback) => {
        ...
        try {
            ...
            return OpenDSUSafeCallback(callback)(createOpenDSUErrorWrapper("Failed to retrieve bricks meta for path "+ barPath, err));
        }
