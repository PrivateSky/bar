...
function ArchiveConfigurator() {
    ...
    this.getFavouriteEndpoint = () => {
        ...
        did = config.did;
        return did.getFavouriteEndpoint();
    }
    ...
    this.getBarMapId = () => {
        if (config.did) {
            return config.did.getAnchorAlias();
        }
        if (config.seed) {
    ...
    this.setAnchorVerificationStrategy = (strategy) => {
        config.anchorVerificationStrategy = strategy;
    }

    this.getAnchorVerificationStrategy = () => {
        return config.anchorVerificationStrategy;
    }
    ...
    this.getKey = (key) => {
        if (config.did) {
            ...
            return config.did.getKeyHash();
        }

        console.log('getting seed key');
